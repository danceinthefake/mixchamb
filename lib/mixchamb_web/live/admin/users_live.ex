defmodule MixchambWeb.Admin.UsersLive do
  @moduledoc """
  ...
  def mount(_params, _session, socket) do
    if connected?(socket) do
      ...
      Phoenix.PubSub.subscribe(Mixchamb.PubSub, @online_topic)
    end
  ...
  def handle_event("delete", %{"id" => id}, socket) do
    case Accounts.delete_anonymous_user(id) do
      {:ok, user} ->
        ...
        Mixchamb.Audit.log_as(socket.assigns.current_admin, "force_expire_user", "user:#{id}", %{
