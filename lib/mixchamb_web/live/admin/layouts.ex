defmodule MixchambWeb.Admin.Layouts do
  @moduledoc """
  ...
  @tabs [
    %{
      label: "Dashboard",
      path: "/admin",
      view: MixchambWeb.Admin.DashboardLive,
      icon: "hero-squares-2x2"
    },
    %{
      label: "System",
      path: "/admin/system",
      view: MixchambWeb.Admin.SystemLive,
      icon: "hero-cpu-chip"
    },
    %{
      label: "Chambers",
    ...
    %{
      label: "Activity",
      path: "/admin/activity",
      view: MixchambWeb.Admin.ActivityLive,
      icon: "hero-bolt"
    },
    %{
      label: "Sweepers",
      path: "/admin/sweepers",
      view: MixchambWeb.Admin.SweepersLive,
      icon: "hero-trash"
    },
    %{
      label: "Cluster",
      path: "/admin/cluster",
      view: MixchambWeb.Admin.ClusterLive,
      icon: "hero-globe-alt"
    },
    %{
      label: "Ops",
      path: "/admin/ops",
      view: MixchambWeb.Admin.OpsLive,
      icon: "hero-megaphone"
    },
    %{
      label: "Rate limits",
      path: "/admin/rate-limits",
      view: MixchambWeb.Admin.RateLimitsLive,
      icon: "hero-no-symbol"
    },
    %{
      label: "Health",
      path: "/admin/health",
      view: MixchambWeb.Admin.HealthLive,
      icon: "hero-heart"
    },
    %{
      label: "BEAM",
