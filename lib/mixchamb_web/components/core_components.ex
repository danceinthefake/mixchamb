defmodule MixchambWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    if count = opts[:count] do
      Gettext.dngettext(MixchambWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MixchambWeb.Gettext, "errors", msg, opts)
    end
  end
