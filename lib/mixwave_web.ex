defmodule MixwaveWeb do
  ...
  defp html_helpers do
    quote do
      ...
      use LiveVue.Components, vue_root: ["./assets/vue", "./lib/mixwave_web"]
      ...
      import Phoenix.HTML
      # Core UI components
      import MixwaveWeb.CoreComponents

      # Common modules used in templates
      alias Phoenix.LiveView.JS
      alias MixwaveWeb.Layouts
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        endpoint: MixwaveWeb.Endpoint,
        router: MixwaveWeb.Router,
        statics: MixwaveWeb.static_paths()
    end
  end
