defmodule MixchambWeb do
  ...
  def controller do
    quote do
      ...
      use Gettext, backend: MixchambWeb.Gettext
  ...
  defp html_helpers do
    quote do
      ...
      use LiveVue.Components, vue_root: ["./assets/vue", "./lib/mixchamb_web"]
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        endpoint: MixchambWeb.Endpoint,
        router: MixchambWeb.Router,
        statics: MixchambWeb.static_paths()
    end
  end
